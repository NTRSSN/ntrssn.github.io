...
//       $("volumeBar").prop('muted', false);
//   } else {
//       muteContainer.addClass('mute-active');
//       $("volumeBar").prop('muted', true);
//   }
...
let muteControl = document.getElementById('mute');

// muteControl.addEventListener('click', soundOff);
...
//     // fileChooser = document.querySelector('.file-chooser'), <---- позволяет загрузить свой видеофайл и проиграть его во встроенном в браузер плеере
...
// позволяет загрузить свой видеофайл и проиграть его во встроенном в браузер плеере
...
// fileChooser.addEventListener('change', selectVideoFile); <---- позволяет загрузить свой видеофайл и проиграть его во встроенном в браузер плеере
